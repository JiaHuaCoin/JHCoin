...
int64 nChainStartTime = 1468038113;
...
const string strMessageMagic = "JHCoin Signed Message, sun:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	nRewardCoinYear = 1.0 * MAX_MINT_PROOF_OF_STAKE; // year 2 0.5%
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in JHCoin
    bool fStrictPayToScriptHash = true; // Always active in JHCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JHCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "ZSD TO MOON and SUN, BY STORM KNIGHT";
        CTransaction txNew;
        ...
        block.nVersion = 1;
		               //1432464189 1431464189
        block.nTime    = nChainStartTime + 35;
	...
	if (true  && (block.GetHash() != hashGenesisBlock)) 
	{
        ...
        assert(block.hashMerkleRoot == uint256("0x5e9b0126566c59251eca1ff7ba07cf3ec2ab80233c856ee47a26853dfbd8db00"));
		assert(block.GetHash() == (!fTestNet ? hashGenesisBlock : hashGenesisBlockTestNet));

// ####block.GetHash() == 00007bab9f2dcb835a92ed926bd718b649b60af1ed5390417ec48fb0a04940a7
// ####block.hashMerkleRoot == 0xbb53e11bb7c82702b96c60eb1fb22f56a4afc744a67cc85c4a69167d86baa3a0
// ####block.nTime = 1458827684 
// ####block.nNonce = 16880 
